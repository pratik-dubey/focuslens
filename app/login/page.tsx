      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
          ...
          <div className="card-brutal p-8 bg-brand-white">
            <h1 className="font-mono font-bold text-3xl mb-1">Welcome back.</h1>
            <p className="font-mono text-sm text-gray-500 mb-8">Log in to see your focus data.</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div>
                ...
                <input type="password" required placeholder="••••••••" className="input-brutal"
            ...
            <button disabled className="btn-brutal-outline w-full justify-center text-sm flex items-center gap-2 cursor-not-allowed bg-gray-500/70">
            ...
            <p className="font-mono text-xs text-center text-gray-500 mt-6">
              No account?{' '}
              <Link href="/signup" className="font-bold underline">Sign up free</Link>
            </p>
          </div>
        </motion.div>
      </div>
